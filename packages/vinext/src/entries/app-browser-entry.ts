/**
 * App Router browser entry generator.
 *
 * Extracted from server/app-dev-server.ts — generates the virtual browser
 * entry module that hydrates the page and handles client-side navigation.
 */
